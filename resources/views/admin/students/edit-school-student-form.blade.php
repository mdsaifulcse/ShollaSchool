        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    <form id="editStudent" action="{{url('/update-school-student')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">&nbsp;</label>
                                    <input type="hidden" name="school_student_id" value="{{$studentInfoById->id}}" />
                                    <input type="submit" name="student_info" required class="btn btn-warning btn-block btn-lg" value="Update Student Info">
                                </div>
                            </div>
                        </div><!--end row-->
                    </form>
                    <a href="{{url('/manage-school-student')}}" class="btn btn-success">&laquo; Back</a>
                </div>
            </div>
        </div>
    </div>
