...
<script type="text/javascript" src="{{asset('/front/')}}/source/jquery.fancybox.pack.js?v=2.1.7"></script>
<script type="text/javascript" src="{{asset('/front/')}}/source/helpers/jquery.fancybox-buttons.js?v=1.0.5"></script>
<script type="text/javascript" src="{{asset('/front/')}}/js/mixitup.min.js" ></script>
<script type="text/javascript" src="{{asset('/front/')}}/js/jquery.fitvids.js" ></script>


<script src="{{asset('/front/')}}/js/custome.js"></script>
