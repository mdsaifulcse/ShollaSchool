                ...
                <div class="contact-area">
                    <div class="col-md-4">
                        <div class="contact-info">
                            ...
                            <p>
                                <span><i class="fa fa-volume-control-phone" aria-hidden="true"></i> {{$contactInfo->first_mobile}}</span><br/>
                                <span><i class="fa fa-volume-control-phone" aria-hidden="true"></i> {{$contactInfo->second_mobile}}</span>
                            </p>
                            <p>
                                Email: {{$contactInfo->contact_email}} <br/>
                    ...
                    <div class="col-md-8">
                        <div class="contact-form">
                            ...
                            {!! Form::open(['url'=>'/new-message', 'method'=>'POST']) !!}
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {{Form::text('name', $value=Null, ['class'=>'form-control','placeholder'=>'Your name','required'=>'required'])}}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {{Form::email('email',$value=Null, ['placeholder'=>'Your eMail','class'=>'form-control','required'=>'required'])}}
                                            <span class="text-danger">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {{Form::number('mobile', $value=Null, ['placeholder'=>'mobile number','class'=>'form-control','required'=>'required'])}}
                                            <span class="text-danger">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {{Form::text('location',$value=Null, ['placeholder'=>'Your location','class'=>'form-control','required'=>'required'])}}
                                            <span class="text-danger">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            {{Form::textarea('message',$value=Null, ['placeholder'=>'Write your Opinion','class'=>'form-control','required'=>'required','rows'=>'4'])}}
                                            <span class="text-danger">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            {{Form::submit('Message-Send', ['class'=>'btn btn-success'])}}
                                        </div>
                                    </div>
                                </div>
                            {!! Form::close() !!}
