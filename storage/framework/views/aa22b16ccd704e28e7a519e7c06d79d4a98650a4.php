                ...
                <div class="overview history">
                    <div class="panel panel-info">
                        ...
                        <div class="panel panel-body">
                            ...
                            <img src="<?php echo e(asset($principalSpeech->person_image)); ?>" title="SHOLLA HIGHER SECONDARY SCHOOL & College Principal's images" class="img-responsive img-thumbnail center-block"> <br><br>
