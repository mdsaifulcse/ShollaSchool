        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="" action="<?php echo e(url('/new-administrator')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('designation_id',$designations,[],['class'=>'form-control select','placeholder'=>'Select one','required'=>true])); ?>
