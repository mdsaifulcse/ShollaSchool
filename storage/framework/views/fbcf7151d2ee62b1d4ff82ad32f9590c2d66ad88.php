        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="" action="<?php echo e(url('/new-teacher')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php if($teacherSerial==0): ?>
                                        <input type="number" name="serial_no" value="1" min="1" class="form-control">
                                        <?php else: ?>
                                            <input type="number" name="serial_no" value="<?php echo e($teacherSerial+1); ?>" min="1" class="form-control">
                                            <?php endif; ?>
                                        <span class="text-danger">
