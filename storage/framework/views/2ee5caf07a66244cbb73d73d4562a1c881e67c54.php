                ...
                <div class="overview history">
                    <div class="panel panel-info">
                        ...
                        <div class="panel panel-body">
                            <h3 class="text-primary"><?php echo e($rule->title); ?> </h3><hr>
                            <img src="<?php echo e(asset($rule->image)); ?>" title="SHOLLA HIGHER SECONDARY SCHOOL & College history images" class="img-responsive img-thumbnail center-block">
