<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="<?php echo e(url('/home')); ?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
            </li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(url('/add-slider')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(url('/add-notice')); ?>">
                            <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Notice</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/manage-notice')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(url('/add-lecture')); ?>">
                            <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Lecture</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/manage-lecture')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(url('/add-routine')); ?>">
                            <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Routine</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/manage-routine')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(url('/manage-rules-history-property-info')); ?>">
                            <i class="fa fa-wrench" aria-hidden="true"></i> Manage School Info</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/manage-about-school')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(url('/add-administrator')); ?>">
                            <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Administrator</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/manage-administrator')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(url('/add-stuff')); ?>">
                            <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Stuff</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/manage-stuff')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(url('/manage-speech')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(url('/add-meritorioue-student')); ?>">
                            <i class="fa fa-user-plus" aria-hidden="true"></i> Add Meritorious Student</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/manage-meritorious')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(url('/manage-Overview')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(url('/add-result')); ?>">
                            <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Result</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/manage-result')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="<?php echo e(url('/manage-academic-content')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(url('/add-photo')); ?>">
                            <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Photo</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/manage-photo')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(url('/add-alumni-student')); ?>">
                            <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Alumni Student</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/manage-alumni-student')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(url('/manage-contact-info')); ?>">
                            <i class="fa fa-map-marker" aria-hidden="true"></i> Update Contact Info</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/message-list')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(url('/update-admin')); ?>">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo e(route('class-of-school.index')); ?>">
