                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?php $__currentLoopData = $administrators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $administrator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="odd gradeX">
                                ...
                                <td><img src="<?php echo e(asset($administrator->image)); ?>" width="50"></td>
                                <td> <?php echo e($administrator->mobile); ?> </td>
                                <td> <?php echo e($administrator->email); ?> </td>
                                <td class="bg-success"> <?php echo e($administrator->administrator_type); ?> </td>
                                <td class="bg-success"> <?php echo e($administrator->administratorDesignation->designation_name); ?> </td>
                                <td>
                                    <?php if($administrator->aministrator_status==1): ?>
                                ...
                                <td> <?php echo e($administrator->present_address); ?> </td>
                                <td>

                                    <a href="<?php echo e(url('/edit-administrator/'.$administrator->id)); ?>" class="btn btn-warning btn-xs" title="Edit Teacher Information">
